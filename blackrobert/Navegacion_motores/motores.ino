...
// ----- MOTOR A
const int L_PWM=8; //ENA
const int IN1=7;
const int IN2=6;
const int L_ENCODER=A0;
const int L_ENCODER_1=A1;
//------ MOTOR B
const int IN3=5; 
const int IN4=4;
const int R_PWM=3; // ENB
const int R_ENCODER=A2;
const int R_ENCODER_1=A3;
...
{   
  l_rpm = 60*100*(l_encCount/64);  //calculate motor speed, unit is rpm
  l_encCount=0;
  l_error = l_w - l_rpm; 
  ...
  r_rpm = 60*100*(r_encCount/64);  //calculate motor speed, unit is rpm
  r_encCount = 0;
  r_error = r_w - r_rpm; 
